...
public class Zan extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String type=request.getParameter(JokeConfig.TYPE_ZAN);
		if(joke_id==null||joke_id.equals("")){
			result=OutJson.outZan(OutJson.FAIL);
		}else{
			if(new UserDao().updateZan(joke_id, type)){
				result=OutJson.outZan(OutJson.SUCCESS);
			}else{
				result=OutJson.outZan(OutJson.FAIL);
			}
		}
